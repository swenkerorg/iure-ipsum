...
[![Coverage Status](https://coveralls.io/repos/github/swenkerorg/iure-ipsum/badge.svg)](https://coveralls.io/github/swenkerorg/iure-ipsum)
[![ci](https://github.com/swenkerorg/iure-ipsum/actions/workflows/ci.yml/badge.svg)](https://github.com/swenkerorg/iure-ipsum/actions/workflows/ci.yml)
[![NPM Version](https://img.shields.io/npm/v/@swenkerorg/iure-ipsum.svg)](https://www.npmjs.com/package/@swenkerorg/iure-ipsum)
[![NPM Downloads](https://img.shields.io/npm/dm/@swenkerorg/iure-ipsum.svg)](http://npm-stat.com/charts.html?package=@swenkerorg/iure-ipsum)
[![jsDelivr hits (npm)](https://img.shields.io/jsdelivr/npm/hw/@swenkerorg/iure-ipsum)](https://www.jsdelivr.com/package/npm/@swenkerorg/iure-ipsum)
...
```
npm install @swenkerorg/iure-ipsum
```
...
import { supportTransform } from "@swenkerorg/iure-ipsum";
...
```js
// EXAMPLES
import { getAttribute, hasAttribute, setAttribute } from "@swenkerorg/iure-ipsum";
...
```js
// EXAMPLES
import { support3DTransform } from "@swenkerorg/iure-ipsum";
...
```js
// EXAMPLES
import { addClass, removeClass, hasClass } from "@swenkerorg/iure-ipsum";
...
```js
// EXAMPLES
import { on, off, one, passiveHandler } from "@swenkerorg/iure-ipsum";
...
```js
// EXAMPLES
import { getElementAnimationDuration } from "@swenkerorg/iure-ipsum";
...
```js
// EXAMPLES
import { isArray, isHTMLElement, isElementsArray } from "@swenkerorg/iure-ipsum";
...
The **_Data_** and **_Timer_** utilities have their own specifics, you might want to check the [wiki](https://github.com/swenkerorg/iure-ipsum/wiki).

```js
// EXAMPLES
import { emulateTransitionEnd, distinct } from "@swenkerorg/iure-ipsum";
...
```js
// EXAMPLES
import { querySelector, querySelectorAll, documentAll, matches } from "@swenkerorg/iure-ipsum";
...
```js
// EXAMPLES
import { on, off, one, mouseClickEvents, touchEvents, passiveHandler } from "@swenkerorg/iure-ipsum";
...
```js
// Example
import on from "@swenkerorg/iure-ipsum/src/event/on";
import addClass from "@swenkerorg/iure-ipsum/src/class/addClass";
import getElementById from "@swenkerorg/iure-ipsum/src/selectors/getElementById";
import mouseclickEvent from "@swenkerorg/iure-ipsum/src/strings/mouseclickEvent";
...
**shorty** is released under the [MIT License](https://github.com/swenkerorg/iure-ipsum/blob/master/LICENSE)
